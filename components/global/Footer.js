  ...
  return (
    <footer className="bg-[#0f0f10] text-white mt-16">
      <div className="mx-auto max-w-7xl px-4">
          ...
          <div>
            ...
            <div className="flex items-center justify-center md:justify-start">
              <input
                ...
                className="w-full bg-transparent border border-gray-500 rounded-l-md px-3 py-2 text-sm placeholder-gray-400 focus:outline-none max-w-sm"
              />
              <button className="border border-gray-500 border-l-0 rounded-r-md px-3 py-2.5">
        ...
        <div className="border-t border-gray-800 py-5 flex flex-col md:flex-row items-center justify-center md:justify-between gap-4 text-sm text-center md:text-left">
          <div className="flex gap-3 flex-wrap justify-center md:justify-start">
            {[
              { name: "VISA", src: "/footer-images/visa.png" },
              { name: "MASTER", src: "/footer-images/mastercard.png" },
              { name: "G PAY", src: "/footer-images/googlepay.png" },
              { name: "AMEX", src: "/footer-images/amexx.jpg" },
              { name: "PAYPAL", src: "/footer-images/paypal.png" },

            ].map((p, i) => (
              <div
                key={i}
                className="rounded-md bg-white p-1 flex items-center justify-center"
              >
                <Image
                  src={p.src}
                  alt={p.name}
