...
export default function ProfileSidebar() {
    ...
    const isAddressPage = pathname.startsWith('/profile/manage-addresses');
    ...
    const isSettingPage = pathname.startsWith('/profile/settings');
    ...
    return (
        <div className="sidebarContainer bg-white border-gray-300 border-2">
            ...
            <div className="linksWrapper border-t-2 border-gray-300 py-5 flex flex-col">
                ...
                <Link href="/profile/my-wishlists" className={`flex gap-2 font-medium text-lg py-3 px-5 profileSidebarLink ${isMyWishlistsPage ? 'active' : ''}`}>
                ...
                <Link href="/profile/manage-addresses" className={`flex gap-2 font-medium text-lg py-3 px-5 profileSidebarLink ${isAddressPage ? 'active' : ''}`}>
                ...
                <Link href="/profile/saved-cards" className={`flex gap-2 font-medium text-lg py-3 px-5 profileSidebarLink ${isCardsPage ? 'active' : ''}`}>
                ...
                <Link href="/profile/notifications" className={`flex gap-2 font-medium text-lg py-3 px-5 profileSidebarLink ${isNotificationsPage ? 'active' : ''}`}>
                    ...
                    Notifications</Link>
                <Link href="/profile/settings" className={`flex gap-2 font-medium text-lg py-3 px-5 profileSidebarLink ${isSettingPage ? 'active' : ''}`}>
