    ...
    return (
        <div className="w-full flex flex-col lg:flex-row mt-[-4rem] lg:mt-[-7rem]">
            <div className="imageWrapper hidden lg:block lg:w-1/2">
                <Image src="/images/login-image.png" width={6000} height={6000} className='h-[50vh] lg:h-[100vh] object-cover' alt="login-image" />
            </div>
            <div className='contentWrapper flex flex-col justify-center px-4 sm:px-6 lg:pl-10 w-full lg:w-1/2'>
                ...
                <div className='formWrapper'>
                    <form className='form w-full sm:w-3/4 lg:w-2/3 max-w-md flex flex-col gap-4 sm:gap-5 mt-5' onSubmit={handleLogin}>
                        ...
                        <div className="fieldGroup flex justify-between items-center">
