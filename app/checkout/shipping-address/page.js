      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            {addresses.map((a) => (
              <div key={a.id} className={`relative border rounded-xl p-5 transition-colors ${selectedId === a.id ? 'bg-gray-50' : 'bg-white'}`}>
                ...
                <div className="flex items-center gap-3 mt-6">
                  <button className="px-6 h-9 border rounded-md text-sm font-medium hover:bg-gray-50 flex items-center gap-2">
          ...
          <form onSubmit={addAddress} className="space-y-5">
            <div>
