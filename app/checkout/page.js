    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-8">
          <div className="grid grid-cols-12 pb-6 text-sm font-medium text-gray-500 border-b border-gray-100">
          ...
          <div className="divide-y divide-gray-100">
            {cart.map((item) => (
              <div key={item.id} className="grid grid-cols-12 py-8 items-center">
                ...
                <div className="col-span-2 text-center text-gray-900 font-semibold">
                ...
                <div className="col-span-2 flex items-center justify-center">
                  <div className="flex items-center border border-gray-300 rounded-lg overflow-hidden h-10">
                    <button
                      className="w-10 h-full grid place-items-center text-gray-700 hover:bg-gray-50 transition-colors"
                      onClick={() => changeQty(item.id, -1)}
                      aria-label="Decrease quantity"
                    >
                      –
                    </button>
                    <div className="w-10 h-full grid place-items-center text-gray-900 font-medium">
                      {item.qty}
                    </div>
                    <button
                      className="w-10 h-full grid place-items-center text-gray-700 hover:bg-gray-50 transition-colors"
